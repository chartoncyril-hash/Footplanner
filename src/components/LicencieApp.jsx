                ...
                {typeCfg.has_expiry && (
                  <div style={{ marginTop:10 }}>
                    ...
                    <div style={{ display:'flex', gap:8, alignItems:'center' }}>
                      <input type="date" value={expiryInputs[type] ?? (doc?.date_expiration || '')} onChange={e => setExpiryInputs(p => ({ ...p, [type]: e.target.value }))} style={{ flex:1, minWidth:0, height:42, padding:'0 12px', borderRadius:10, border:'1px solid rgba(255,255,255,0.12)', background:'rgba(255,255,255,0.05)', color: (expiryInputs[type] ?? doc?.date_expiration) ? '#f1f5f9' : '#64748b', fontSize:14, fontFamily:'inherit', boxSizing:'border-box', WebkitAppearance:'none', appearance:'none', lineHeight:'42px' }} />
